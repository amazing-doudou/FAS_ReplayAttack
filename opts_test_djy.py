...
def get_opts():
    ...
    opt.val_list = '2get_list/test_result/20180_fanyifu_crop.txt' #test1203 train1203_0first 0120_test_data_djy.txt 0210_test_data 0224_test_data .txt Test3_2020316_crop
     
    opt.out_root = '/mnt/sdb4/2d_project/sigle_result/'
    opt.out_path = os.path.join(opt.out_root,opt.exp_name)
    opt.out_path_test = '/mnt/sdb4/2d_project/sigle_result/test0706_mobilenetv2_small_dropout_0d1_1024_Adam_128_bn_cce_30e-4_0704_train_new_data/'
